...
void ChangeMenuState(HWND hwnd, UINT MenuItem, UINT state)
{
	...
	SetMenuItemInfoA(GetMenu(hwnd), MenuItem, false, &mi);
	DrawMenuBar(hwnd);
}
...
//-----------------------------------------------------------------------------
//
//  The following 3 functions enable the client to use the file dialog common control
//
//-----------------------------------------------------------------------------
